...
<div class="card">
  <div class="card-body pt-3">
      <div class="text-center pb-2">
              ...
              <p>As the Admin of Great Kings Academy, you can manage the Existing Library by Deleting the books uploaded by the teachers.</p>
                ...
                while($row = $result->fetch_assoc()){
                   ...
                   ';
                    ...
                    ?>
                     ...
                     <button type="submit" class="btn btn-success form-control mb-3" name="admin-manage-library">Existing Library</button>
                     </div>
              </form>
                    </div>
                    </div>
