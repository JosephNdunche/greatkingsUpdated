...
<div class="card text-center">
            ...
            <div class="text-center">
              ...
              <p>You can only manage <span class="text-success fw-bold"><?php echo $row['class']; ?></span> class because you are their class teacher.</p>
            ...
            ?>
              ...
              <i class='bi bi-emoji-frown text-danger' style='font-size: 2.5rem;'></i><br />No Student Found</div>";
              }
