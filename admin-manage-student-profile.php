              ...
              <div class="tab-content pt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">
                        ...
                        <button type="submit" name="admin-approve-student" class="btn btn-success">Approve Student</button>
                    </div>
                    <div class="col-lg-3 col-md-4 label">Delete Student</div>
                    <button type="submit" name="admin-delete-student" class="btn btn-success my-2">Delete Student Record</button>
