              ...
              <div class="tab-content pt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">
                        ...
                        <button type="submit" name="approve-staff" class="btn btn-success my-3">Approve Staff</button>
                    </div>

                    <div class="col-lg-3 col-md-4 label">Delete Staff</div>
                    <div class="col-lg-9 col-md-8">
                        <input type="hidden" name="staff_id" value="<?php echo $staff_id; ?>">
                        <button type="submit" name="delete-staff" class="btn btn-success my-2">Delete Staff Record</button>
                    </div>
