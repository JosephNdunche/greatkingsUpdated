...
<div class="container mt-5 pt-5">
  ...
  <nav>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="main-dashboard.php"><i class="bi bi-house-door"></i></a></li>
        <li class="breadcrumb-item"><a href="#">Update Library</a></li>
                </ol>
  </nav>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="404.php?path=uploads/<?= $get_data['pdf']; ?>" class="btn btn-primary form-control">Update Book</a>
                    </div>
                  </div>
                </div>
              </div>
