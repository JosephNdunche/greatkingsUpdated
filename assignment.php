    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">file Editor</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-6">
          ...
          <div class="card text-center">
            ...
            <div class="text-center py-3">
              ...
              <p>You can Upload file here and send it to the desired class.
            </p>
              <!-- TinyMCE Editor -->
            ...
            <select name="class" id="" class="form-control mt-3">
                     ...
                     <label for="deadline" class="mt-3">Enter Submission Date</label>
                      ...
                      <button class="btn text-white form-control my-3" name="assignment-btn" style="background-color: green;">Upload file</button>
                      </div>
