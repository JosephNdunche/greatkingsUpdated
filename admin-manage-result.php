...
<div class="card text-center">
            <div class="card-body pt-3">
              ...
              <i class="bi bi-exclamation-circle success" style="font-size: 2.5rem;"></i>
              </div>
              ...
              <select name="class" class="form-control form_data">
                     ...
                     <button type="submit" class="btn btn-success form-control mb-4" name="admin-manage-student">Manage Result</button>
                     </div>
              </form>
         </div>
    </div>
