                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex align-items-center justify-content-between">
                      <a href="admin-view-library.php?path=uploads/<?= $get_data['pdf']; ?>" class="btn btn-primary form-control">Download</a>
                      <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                      <input type="hidden" name="library_id" value="<?= $library_id; ?>">
                      <button type="submit" name="admin-existing-library-check" class="btn btn-success form-control ms-2">Delete</button>
                    </form>
                    </div>
                  </div>
                </div>
